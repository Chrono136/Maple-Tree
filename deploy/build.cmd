...
SET COVERS=%DEPLOY%covers\
SET OPENSSL=C:\openssl11\bin64\libcryptoMD.dll
...
CALL 7z -x!*.lnk -x!*.zip -x!MapleSeed-*.exe -xr!libs a "%BINARIES%%FILEOUT%.zip" %RELEASE%* %OPENSSL%
::cmd /k